    ...
    <main>
      ...
      <section className="section about-hero">
        ...
        <p className="about-lead">
          I don't have my entire life figured out.
          I don't think anyone really does.
          I'm just trying to experience more of it,
          one journey, one conversation and one
          unexpected road at a time.
        </p>
      ...
      <section className="section about-story">
        ...
        <div className="about-story-grid">
          ...
          <div>
            <p className="lead">
              {siteName} started with a simple
              idea: life becomes a lot more
              interesting when you stop living it
              entirely on someone else's terms.
            </p>

            <p>
              I've always been curious about what
              exists beyond the familiar. Different
              roads. Different places. Different
              people. Different ways of looking at
              life.
            </p>

            <p>
              Somewhere along the way, travelling
              stopped being just about reaching a
              destination. The journey became the
              interesting part.
            </p>
          </div>
          ...
          <div>
            <p>
              ...
              The places that weren't on the plan.
            </p>

            <p>
              Those are often the moments that stay
              with me much longer than the
              destination itself.
            </p>

            <p>
              This website is where I keep those
              moments.
            </p>
          </div>
      ...
      <section className="section philosophy">
        ...
        <div>
          ...
          <p className="philosophy-copy">
            I don't think life should become a race
            for money, possessions and a version of
            success someone else chose for us.
          </p>
